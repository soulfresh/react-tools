...
<Canvas>
  <Story name="Currency" decorators={[ColumnOfItems]}>
    ...
    <Currency value={202838} />
    <p>Try typing into the following inputs to see how numbers
    get formatted as you type.</p>
    <label>USD de-DE</label>
    <Currency input locale='de-DE' />
    <label>EUR en-US</label>
    <Currency input locale='en-US' currency="EUR" />
    <label>EUR en-US with currency code</label>
    <Currency input locale='en-US' currency="EUR" currencyDisplay="code" />
    <label>EUR de-DE</label>
    <Currency input locale='de-DE' currency="EUR" />
    <label>EUR de-DE with currency code</label>
    <Currency input locale='de-DE' currency="EUR" currencyDisplay="code" />
    <label>INR hi-IN</label>
    <Currency input locale='hi-IN' currency="INR" />
    <label>THB Thailand</label>
    <Currency input locale='th' currency="THB" />
    <label>Yaun China</label>
    <Currency input locale="zh-Hans-CN-u-nu-hanidec" currency='CNY' />
  </Story>
</Canvas>
